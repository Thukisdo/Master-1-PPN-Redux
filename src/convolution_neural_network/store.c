...
Layer** load_neural_network(Context* context) {
  ...
  // au cas ou
  for (u64 i = 0; i < nn_size - 1; i++) { init_layer(layers[i], context->topology[i + 1]); }
